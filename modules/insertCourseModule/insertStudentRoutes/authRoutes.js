...
// const StudentInfo = require('../controllers/insertStudentController');
...
// router.get('/addStudent', StudentInfo.form);

// router.post('/register', urlencodedParser, StudentInfo.insertStudent);
